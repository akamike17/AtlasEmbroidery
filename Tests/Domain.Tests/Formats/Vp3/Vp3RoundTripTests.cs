...
/// <summary>
/// Round-trip semantic fidelity tests for VP3 format
/// </summary>
public sealed class Vp3RoundTripTests
{
    ...
    public async Task RoundTrip_SimpleShape_PreservesStitches()
    {
        ...
        // VP3 doesn't preserve design name in header (writes date instead)
    ...
    public async Task RoundTrip_ColorChanges_Preserved()
    {
        ...
        roundTripProject.Should().NotBeNull();
        // VP3 reader doesn't fully reconstruct palette from color changes
        // But should at least parse the file
    }
